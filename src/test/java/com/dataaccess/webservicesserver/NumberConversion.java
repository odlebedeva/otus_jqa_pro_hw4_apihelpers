 ...
 * 2024-04-02T20:08:35.562+03:00
 * Generated source version: 3.3.4
 *
 */
@WebServiceClient(name = "NumberConversion",
                  wsdlLocation = "file:/D:/LocalData/otus/otus_practice_4/otus_jqa_pro_hw4_apihelpers/src/test/resources/wsdl/numberconversion.wsdl",
...
public class NumberConversion extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/LocalData/otus/otus_practice_4/otus_jqa_pro_hw4_apihelpers/src/test/resources/wsdl/numberconversion.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(NumberConversion.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/LocalData/otus/otus_practice_4/otus_jqa_pro_hw4_apihelpers/src/test/resources/wsdl/numberconversion.wsdl");
        }
        WSDL_LOCATION = url;
    }
